    const tech = {
        ...
        tech: [{
            ...
            //************************************************** 
            {
                ...
                description: "gain <strong class='color-h'>1 health</strong> for every <strong>10</strong> mob kills<br>but max <strong class='color-h'>health</strong> decreased by <strong>25%</strong>",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                effect() {
                    tech.isVampiricRounds = true;
                    m.setMaxHealth();
                },
                remove() {
                    tech.isVampiricRounds = false;
                    m.setMaxHealth();
                }
            },
            {
                name: "overcharge",
                description: "when <strong class='color-f'>energy</strong> is full, <strong class='color-d'>damage</strong> increased by <strong>60%</strong><br>but <strong class='color-f'>energy</strong> regeneration decreased by <strong>30%</strong>",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
            ...
            {
                name: "adaptive armor",
                description: "reduce <strong class='color-harm'>harm</strong> by <strong>8%</strong> per consecutive hit<br>resets when you avoid damage for <strong>3 seconds</strong>",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
            ...
            },
            {
                ...
                description: "bullets have a <strong>20%</strong> chance to <strong>bounce</strong><br>bounced bullets deal <strong>50%</strong> <strong class='color-d'>damage</strong>",
                maxCount: 3,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                effect() {
                    ...
                    tech.ricochetChance = (tech.ricochetChance || 0) + 0.2;
                },
                remove() {
                    tech.isRicochet = false;
                    tech.ricochetChance = 0;
                }
            },
            {
                name: "momentum transfer",
                description: "increase <strong class='color-d'>damage</strong> based on <strong>velocity</strong><br><strong>10%</strong> per <strong>10 velocity</strong> units",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                requires: "not inertial frame",
                effect() {
                    tech.isMomentumDamage = true;
                },
                remove() {
                    tech.isMomentumDamage = false;
                }
            },
            {
                name: "shield generator",
                description: "spawn a <strong>rotating shield</strong> that blocks <strong>3 hits</strong><br>regenerates every <strong>10 seconds</strong>",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                requires: "not mass-energy",
                effect() {
                    tech.isShieldGenerator = true;
                    tech.shieldHits = 3;
                    tech.shieldMaxHits = 3;
                },
                remove() {
                    tech.isShieldGenerator = false;
                    tech.shieldHits = 0;
                }
            },
            {
                name: "berserker",
                description: "gain <strong>15%</strong> <strong class='color-d'>damage</strong> for every <strong>10%</strong> <strong class='color-h'>health</strong> missing<br>you can't pick up <strong class='color-h'>heal</strong> power ups",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                requires: "not anabolic",
                effect() {
                    tech.isBerserker = true;
                    tech.isNoHeals = true;
                },
                remove() {
                    tech.isBerserker = false;
                    if (!tech.isAnabolic) tech.isNoHeals = false;
                }
            },
            {
                name: "fragmentation",
                description: "killed mobs have a <strong>30%</strong> chance to <strong>explode</strong><br>dealing <strong>area damage</strong> to nearby mobs",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                requires: "",
                effect() {
                    tech.isFragmentation = true;
                },
                remove() {
                    tech.isFragmentation = false;
                }
            },
            {
                name: "phase shift",
                description: "after taking damage, become <strong>invulnerable</strong> for <strong>0.5 seconds</strong><br><strong>8 second</strong> cooldown",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                requires: "not mass-energy",
                effect() {
                    tech.isPhaseShift = true;
                    tech.phaseShiftReady = true;
                },
                remove() {
                    tech.isPhaseShift = false;
                    tech.phaseShiftReady = false;
                }
            },
            {
                name: "chain lightning",
                description: "bullets that hit have a <strong>15%</strong> chance to <strong>arc</strong><br>to nearby mobs dealing <strong>25%</strong> damage",
                maxCount: 3,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                requires: "",
                effect() {
                    tech.isChainLightning = true;
                    tech.chainLightningChance = (tech.chainLightningChance || 0) + 0.15;
                },
                remove() {
                    tech.isChainLightning = false;
                    tech.chainLightningChance = 0;
                }
            },
            {
                name: "critical strike",
                description: "<strong>15%</strong> chance for <strong class='color-d'>damage</strong> to be <strong>tripled</strong>",
                maxCount: 3,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                requires: "not crit from scratch tech",
                effect() {
                    tech.isCriticalStrike = true;
                    tech.criticalStrikeChance = (tech.criticalStrikeChance || 0) + 0.15;
                },
                remove() {
                    tech.isCriticalStrike = false;
                    tech.criticalStrikeChance = 0;
                }
            },
            {
                name: "temporal echo",
                description: "spawn a <strong>ghost clone</strong> that mirrors your movement<br>and deals <strong>20%</strong> of your <strong class='color-d'>damage</strong>",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                requires: "",
                effect() {
                    tech.isTemporalEcho = true;
                },
                remove() {
                    tech.isTemporalEcho = false;
                }
            },
            {
                name: "salvage",
                description: "killed mobs have a <strong>8%</strong> chance to drop<br><strong class='color-g'>ammo</strong> or <strong class='color-h'>heal</strong> power ups",
                maxCount: 3,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                effect() {
                    tech.isSalvage = true;
                    tech.salvageChance = (tech.salvageChance || 0) + 0.08;
                },
                remove() {
                    tech.isSalvage = false;
                    tech.salvageChance = 0;
                }
            },
            {
                name: "glass cannon",
                description: "increase <strong class='color-d'>damage</strong> by <strong>80%</strong><br>decrease max <strong class='color-h'>health</strong> by <strong>40%</strong>",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                requires: "not mass-energy",
                effect() {
                    tech.isGlassCannon = true;
                    m.setMaxHealth();
                },
                remove() {
                    tech.isGlassCannon = false;
                    m.setMaxHealth();
                }
            },
            {
                name: "armor piercing",
                description: "bullets ignore <strong>50%</strong> of enemy <strong>defense</strong><br>and deal <strong>20%</strong> more damage to <strong>bosses</strong>",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                requires: "",
                effect() {
                    tech.isArmorPiercing = true;
                },
                remove() {
                    tech.isArmorPiercing = false;
                }
            },
            {
                name: "smoke bomb",
                description: "when <strong class='color-h'>health</strong> drops below <strong>20%</strong><br>teleport randomly and gain <strong>2 seconds</strong> of invulnerability",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                requires: "not mass-energy",
                effect() {
                    tech.isSmokeBomb = true;
                    tech.smokeBombReady = true;
                },
                remove() {
                    tech.isSmokeBomb = false;
                    tech.smokeBombReady = false;
                }
            },
            {
                name: "adrenaline rush",
                description: "increase <strong>movement speed</strong> by <strong>40%</strong> when below <strong>50%</strong> <strong class='color-h'>health</strong>",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                requires: "not mass-energy",
                effect() {
                    tech.isAdrenalineRush = true;
                },
                remove() {
                    tech.isAdrenalineRush = false;
                }
            },
            {
                name: "bullet time",
                description: "while <strong class='color-f'>energy</strong> is above <strong>80%</strong><br>slow time by <strong>15%</strong> for everything except you",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                requires: "not exciton-lattice",
                effect() {
                    tech.isBulletTime = true;
                },
                remove() {
                    tech.isBulletTime = false;
                }
            },
            {
                name: "heavy ordinance",
                description: "bullets are <strong>50%</strong> larger and deal <strong>30%</strong> more damage<br>but <strong>40%</strong> increased <strong><em>delay</em></strong> after firing",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                requires: "",
                effect() {
                    tech.isHeavyOrdinance = true;
                    b.setFireCD();
                },
                remove() {
                    tech.isHeavyOrdinance = false;
                    b.setFireCD();
                }
            },
            {
                name: "quick reflexes",
                description: "<strong>45%</strong> decreased <strong><em>delay</em></strong> after firing<br>bullets deal <strong>20%</strong> less damage",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                requires: "",
                effect() {
                    tech.isQuickReflexes = true;
                    b.setFireCD();
                },
                remove() {
                    tech.isQuickReflexes = false;
                    b.setFireCD();
                }
            },
            {
                name: "explosive rounds",
                description: "bullets create small <strong>explosions</strong> on impact<br>dealing <strong>area damage</strong>",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                    return !tech.isImmuneExplosion
                },
                requires: "not explosion immunity",
                effect() {
                    tech.isExplosiveRounds = true;
                },
                remove() {
                    tech.isExplosiveRounds = false;
                }
            },
            {
                name: "energy vampire",
                description: "dealing damage restores <strong class='color-f'>0.5 energy</strong><br>per <strong>100 damage</strong> dealt",
                maxCount: 3,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                requires: "not exciton-lattice",
                effect() {
                    tech.isEnergyVampire = true;
                    tech.energyVampireRate = (tech.energyVampireRate || 0) + 0.005;
                },
                remove() {
                    tech.isEnergyVampire = false;
                    tech.energyVampireRate = 0;
                }
            },
            {
                name: "lucky shot",
                description: "<strong>5%</strong> chance to not consume <strong class='color-g'>ammo</strong> when firing",
                maxCount: 5,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                requires: "not exciton-lattice",
                effect() {
                    tech.isLuckyShot = true;
                    tech.luckyShotChance = (tech.luckyShotChance || 0) + 0.05;
                },
                remove() {
                    tech.isLuckyShot = false;
                    tech.luckyShotChance = 0;
                }
            },
            {
                name: "revenge",
                description: "for <strong>5 seconds</strong> after taking damage<br>increase <strong class='color-d'>damage</strong> by <strong>35%</strong>",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                    return !tech.isHarmDamage
                },
                requires: "not flux capacitor",
                effect() {
                    tech.isRevenge = true;
                },
                remove() {
                    tech.isRevenge = false;
                }
            },
            {
                name: "poison cloud",
                description: "leave a <strong>damaging trail</strong> that persists for <strong>2 seconds</strong><br>damages mobs that walk through it",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                requires: "",
                effect() {
                    tech.isPoisonCloud = true;
                },
                remove() {
                    tech.isPoisonCloud = false;
                }
            },
            {
                name: "last stand",
                description: "when <strong class='color-h'>health</strong> reaches <strong>0</strong><br>survive with <strong>1 health</strong> and gain <strong>5 seconds</strong> of invulnerability<br>only works <strong>once per level</strong>",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                    return !tech.isDeathAvoid && !tech.isEnergyHealth
                },
                requires: "not anthropic principle, not mass-energy",
                effect() {
                    tech.isLastStand = true;
                    tech.lastStandReady = true;
                },
                remove() {
                    tech.isLastStand = false;
                    tech.lastStandReady = false;
                }
            },
            {
                name: "magnetic field",
                description: "<strong>attract</strong> all power ups within <strong>300 units</strong><br>but reduce <strong class='color-f'>energy</strong> regen by <strong>15%</strong>",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                requires: "not exciton-lattice",
                effect() {
                    tech.isMagneticField = true;
                },
                remove() {
                    tech.isMagneticField = false;
                }
            },
            {
                name: "unstable isotope",
                description: "on death, create a <strong>massive explosion</strong><br>that damages all nearby mobs",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                requires: "not explosion immunity",
                effect() {
                    tech.isUnstableIsotope = true;
                },
                remove() {
                    tech.isUnstableIsotope = false;
                }
            },
            {
                name: "plasma infusion",
                description: "bullets leave a <strong>damaging trail</strong><br>that damages mobs for <strong>1 second</strong>",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                requires: "",
                effect() {
                    tech.isPlasmaInfusion = true;
                },
                remove() {
                    tech.isPlasmaInfusion = false;
                }
            },
            {
                name: "multishot",
                description: "fire <strong>2 additional bullets</strong> at <strong>±15° angles</strong><br>each dealing <strong>40%</strong> damage",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                requires: "",
                effect() {
                    tech.isMultishot = true;
                },
                remove() {
                    tech.isMultishot = false;
                }
            },
            {
                name: "precision aiming",
                description: "increase <strong class='color-d'>damage</strong> by <strong>8%</strong><br>for each second without firing, up to <strong>40%</strong>",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                    return !tech.isNoFireDamage
                },
                requires: "not no fire damage tech",
                effect() {
                    tech.isPrecisionAiming = true;
                    tech.precisionAimingStacks = 0;
                },
                remove() {
                    tech.isPrecisionAiming = false;
                    tech.precisionAimingStacks = 0;
                }
            },
            {
                name: "demon",
                description: "become <strong style='color:#f00;'>DEMONIC</strong><br>gain <strong>100%</strong> max <strong class='color-h'>health</strong><br>bullets ignite enemies, dealing <strong>damage over time</strong><br>but take <strong>50%</strong> more <strong class='color-harm'>harm</strong> from <strong>lasers</strong>",
                maxCount: 1,
                count: 0,
                frequency: 2,
                allowed() {
                ...
                effect() {
                    ...
                    if (m.fieldUpgrades && m.fieldUpgrades[m.fieldMode]) {
                        player.defaultColor = '#f00';
                        if (player.render && player.render.fillStyle) {
                            player.render.fillStyle = '#f00';
                        }
                    }
                },
                remove() {
                    ...
                    m.setMaxHealth();
                    // Reset player color
                    player.defaultColor = '#0cf';
                    if (player.render && player.render.fillStyle) {
                        player.render.fillStyle = '#0cf';
                    }
                }
            },
            //************************************************** 
        ...
        isSneakAttack: null,
        // NEW TECH VARIABLES
        isVampiricRounds: null,
        isOvercharge: null,
        isAdaptiveArmor: null,
        adaptiveArmorStacks: null,
        isRicochet: null,
        ricochetChance: null,
        isMomentumDamage: null,
        isShieldGenerator: null,
        shieldHits: null,
        shieldMaxHits: null,
        isBerserker: null,
        isFragmentation: null,
        isPhaseShift: null,
        phaseShiftReady: null,
        isChainLightning: null,
        chainLightningChance: null,
        isCriticalStrike: null,
        criticalStrikeChance: null,
        isTemporalEcho: null,
        isSalvage: null,
        salvageChance: null,
        isGlassCannon: null,
        isArmorPiercing: null,
        isSmokeBomb: null,
        smokeBombReady: null,
        isAdrenalineRush: null,
        isBulletTime: null,
        isHeavyOrdinance: null,
        isQuickReflexes: null,
        isExplosiveRounds: null,
        isEnergyVampire: null,
        energyVampireRate: null,
        isLuckyShot: null,
        luckyShotChance: null,
        isRevenge: null,
        isPoisonCloud: null,
        isLastStand: null,
        lastStandReady: null,
        isMagneticField: null,
        isUnstableIsotope: null,
        isPlasmaInfusion: null,
        isMultishot: null,
        isPrecisionAiming: null,
        precisionAimingStacks: null,
        isDemon: null
    }